...
setup(
  ...
  version = '1.3.8',      # Start with a small number and increase it with every change you make
...
""",
  ...
  download_url = 'https://github.com/Kronifer/kvJSON/archive/v1.3.6.tar.gz',    # I explain this later on
